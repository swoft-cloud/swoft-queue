...
use Swoft\Queue\PushEvent;
use Swoft\Queue\ExecEvent;
use Swoft\Queue\Serializers\PhpSerializer;
use Swoft\Queue\Serializers\SerializerInterface;
...
abstract class Queue 
{
    ...
    {
        parent::init();
        /** @var \Swoft\Queue\Serializers\PhpSerializer $em */
